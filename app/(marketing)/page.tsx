  ...
  return (
    <>
      <section className="pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32">
        {/* containerで ウィンドウ幅によるwidthを指定してくれる */}
        <div className="container mx-auto flex w-full max-w-[64rem] flex-col items-center px-4 text-center">
          <Link
            href={SiteConfig.links.x}
            target="_blank"
            rel="noreferrer"
            className="bg-muted rounded-2xl px-4 py-1.5 text-sm font-medium text-slate-800"
          >
            xをフォローする
          </Link>
          ...
          <p className="text-muted-foreground max-w-[42rem] leading-normal sm:text-xl">
            このアプリケーションはNext.js
            AppRouterで作られたものです。ユーザーは自由に投稿ろポストすることができます。
          </p>
          {/* space-x-4 間のマージを設定してくれる */}
      ...
      <section
        id="features"
        className="container mx-auto space-y-6 bg-slate-50 px-4 py-8 md:py-12 lg:py-24"
      >
        {/* space-y-6は小要素の隣接セレクタにmarginが指定される指定される */}
        <div className="mx-auto max-w-[58rem] space-y-6 text-center">
          <h2 className="text-3xl font-extrabold md:text-6xl">
            サービスの特徴
          </h2>
          <p className="text-muted-foreground sm:text-lg sm:leading-7">
            このプロジェクトはモダンな技術スタックを使って作られたWebアプリケーションです。Next.jsAppRouterや、contentlayerを利用してマークダウン形式でブログを投稿ができます。
          </p>
        </div>
        <div className="mx-auto grid max-w-[64rem] gap-4 sm:grid-cols-2 md:grid-cols-3">
          <div className="bg-background rounded-t-lg border p-2">
            <div className="flex h-[180px] flex-col justify-center p-6">
              <svg
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground text-sm">
                  AppRouter/Layouts/APIRoutetsの技術を使用。
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-background rounded-t-lg border p-2">
            <div className="flex h-[180px] flex-col justify-center p-6">
              ...
              <div className="space-y-2">
                <h3 className="font-bold">TailwindowCSS</h3>
                <p className="text-muted-foreground text-sm">
                  TailwindowCSSの技術を使用。
                </p>
              </div>
        ...
        <div className="mx-auto text-center">
          <p className="text-muted-foreground sm:text-lg sm:leading-7">
            Post Wraiterはログインするとブログ投稿できるようになります。
          </p>
        </div>
      </section>
      <section
      ...
      >
        <div className="max-w[58rem] mx-auto flex flex-col gap-4 text-center">
          <h2 className="text-3xl font-extrabold md:text-6xl">Comtact Me</h2>
          <p className="text-muted-foreground sm;text:lg sm:leading-7">
